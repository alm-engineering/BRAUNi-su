...
const opList = [
  ...
  },
  {
    ...
    surgeon: "Dr. med. Sabine Koch",
    assistant: "Dr. med. Felix Bauer",
  },
  {
    id: "3",
    caseNumber: "P-2025-0176",
    procedure: "Hernienoperation",
    patientName: "Julia Schneider",
    ...
    diagnosis: "Leistenhernie",
    surgeon: "Dr. med. Tobias Meier",
    assistant: "Dr. med. Julia Kranz",
  },
  {
    id: "4",
    caseNumber: "P-2025-0177",
    procedure: "Koloskopie",
    patientName: "Peter Müller",
    birthDate: "15.06.1968",
    age: "57 Jahre",
    date: "01.12.25",
    time: "11:15 Uhr",
    isActive: false,
          ...
          <div className="flex flex-col gap-4">
            {opList.map((op) => (
              <Link key={op.id} href={`/op/${op.id}/operationsbericht`} className="block">
                <div className="flex gap-6 rounded-xl border bg-white p-5 shadow-sm transition-all hover:shadow-md">
                  <div
